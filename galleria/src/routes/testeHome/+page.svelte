...
<script>
    ...
    // import { lazy } from 'svelte-lazyload';
    import { getAlbuns, getImagePixels, getImagesFromAlbum, setAlbuns } from '../../routes/api/api';
    ...
    onMount(async () => {
        imagePixels = await getImagePixels(numItens);
        thumbnail = await setAlbuns(numItens, imagePixels);
